...
function Input_Decimal (dot) {
    ...
    // doesnt't cause bugs in your operation
...
const Value_ofInput = parseFloat(Display_Value);
...
keys.addEventListener('click' , (event) => {
    ...
    // that was clicked
    const {target} = event;
    // if the elemnt that was clicked on its button, exit the function
